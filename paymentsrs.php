...
mysqli_query($con,"UPDATE `user` SET `paid_user`='1' WHERE id='$session_id'");

mysqli_query($con,"INSERT INTO `payment`(`sdate`, `edate`, `payoption`, `pay_by`, `postid`, `user_id`) VALUES ('$sdate','$edate','$payoption','$pay_by','0','$session_id')");

$notify="Make Payment for Resume";
$type="user";
$link="payment";
...
else
{
	...
	echo "window.location='paid_resume'";
	echo "</script>";
}
?>
