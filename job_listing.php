...
$sql12 = mysqli_query($con,"SELECT * FROM `all_title` WHERE page_nm='job_listing'");
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <h4 class="search-result-text"><?php echo $result12['title2']; ?> <?php $r12 = mysqli_query($con,"SELECT * FROM `post_job` WHERE ad_app='1' AND `job_edate` >  '$today'"); 
					echo mysqli_num_rows($r12); ?> <?php echo $result12['title3']; ?></h4>
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
							...
							$i=0;
							$pageno=1;
							$SqlQueryRun1 = mysqli_query($con,"SELECT * FROM `post_job` WHERE ad_app='1' AND `job_edate` >  '$today'");
							$total_rows=mysqli_num_rows($SqlQueryRun1);
							
							$r123 = mysqli_query($con,"SELECT * FROM `post_job` WHERE ad_app='1' AND `job_edate` >  '$today' limit $startno,$pagesize"); 
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                <div class="pagination-box clearfix">
                                    <ul class="pagination">
										...
										{
										?>
                                        <li><a href="job_listing?start=0"><?php echo $pageno; ?></a></li>
                                       <?php
										}
										else
										{
										?>
										<li><a href="job_listing?start=<?php echo $j; ?>"><?php echo $pageno; ?></a></li>
										<?php
										}
										$pageno++;
										}
										?>
                                        <li>
                                            <a href="job_listing?start=<?php echo $j-$pagesize; ?>" aria-label="Next"> <span aria-hidden="true"><?php echo $result12['title6']; ?></span> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
