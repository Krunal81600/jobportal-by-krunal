...
$sql12 = mysqli_query($con,"SELECT * FROM `all_title` WHERE page_nm='search_result'");
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
						<div class="col-md-8 col-sm-12 col-xs-12">
							...
							{
							?>
                            <h4 class="search-result-text"><?php echo $result12['title2']; ?> <?php $r12 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr'"); 
					echo mysqli_num_rows($r12); ?> <?php echo $result12['title3']; ?></h4>
							...
							{
							?>
							<h4 class="search-result-text"><?php echo $result12['title2']; ?> <?php $r12 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND  position like '%$position%'"); 
					echo mysqli_num_rows($r12); ?> <?php echo $result12['title3']; ?></h4>
							<?php
							} 
							elseif($countrysr!="" && $position!="") 
							{
							?>
							<h4 class="search-result-text"><?php echo $result12['title2']; ?> <?php $r12 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr' AND  position like '%$position%'"); 
					echo mysqli_num_rows($r12); ?> <?php echo $result12['title3']; ?></h4>
							<?php
							}
							else{
							?>
							<h4 class="search-result-text"><?php echo $result12['title2']; ?> <?php $r12 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' "); 
					echo mysqli_num_rows($r12); ?> <?php echo $result12['title3']; ?></h4>
							<?php } ?>
                        </div>
                        <div class="col-md-8 col-sm-12 col-xs-12">
							...
							if($position=="") 
							{
							$sel=mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr' ORDER BY id ASC limit $startno,$pagesize");
							$SqlQueryRun1 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND position like '%$position%' ");
							$total_rows=mysqli_num_rows($SqlQueryRun1);
							} 
							elseif($countrysr=="") 
							{
							$sel=mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND position like '%$position%' ORDER BY id ASC limit $startno,$pagesize");	
							$SqlQueryRun1 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr'");
							$total_rows=mysqli_num_rows($SqlQueryRun1);
							} 
							elseif($position!="" && $countrysr!="")  
							{
							$sel=mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr' AND  position like '%$position%' ORDER BY id ASC limit $startno,$pagesize");	
							$SqlQueryRun1 = mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employee' AND country='$countrysr' AND  position like '%$position%'");
							$total_rows=mysqli_num_rows($SqlQueryRun1);
							}
							else
							{
                                ...
                                <div class="card">
                                    <div class="firstinfo">
                                        ...
                                        <div class="profileinfo">
                                            ...
                                            <div class="hire-btn">
                                            	<a href="user_resume?id=<?php echo $row['id']; ?>" class="btn-default" > <i class="fa fa-location-arrow"></i> <?php echo $result12['title4']; ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
						   ...
						   <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                <div class="pagination-box clearfix">
                                    <ul class="pagination">
										...
										{
										?>
                                        <li><a href="search_result?start=0"><?php echo $pageno; ?></a></li>
                                       <?php
										}
										else
										{
										?>
										<li><a href="search_result?start=<?php echo $j; ?>"><?php echo $pageno; ?></a></li>
										<?php
										}
										$pageno++;
										}
