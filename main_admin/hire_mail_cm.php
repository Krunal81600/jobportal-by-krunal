<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$company_details=$rowaaa['comp_uid'];
		...
		$notify= "Successfully Approved by admin to hire a candidate(".$rowa['user'].").";
		$type="admin";
		$link="user_resume?id=$user_resume";

		$query=mysqli_query($con,"insert into notification(user_id,	byuser_id,notify,type,link) values('$hire_uid','$hire_compid','$notify','$type','$link')");
		
		$success_send=$row['hire_status_cm'];
		$total=$success_send+1;
		mysqli_query($con,"UPDATE `hire` SET `hire_status_cm`='$total' WHERE id='$id'");
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
						  <form method="POST" enctype="multipart/form-data">
							<div class="form-group">				 
		    				  <div class="row">
									<div class="col-md-12">
										<h2>Hired By : <?php echo $rowab['industry']; ?></h2>
										<h2>Hired To : <?php echo $rowabc['user']; ?></h2>
									</div>
								</div>
							</div>
							<div class="form-group">				 
