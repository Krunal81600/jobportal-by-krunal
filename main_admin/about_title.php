<?php
	include('../config.php');
	include('header.php');
	$sql1 = mysqli_query($con,"SELECT * FROM `all_title` WHERE page_nm='about'");
	...
	if(isset($_POST['submit']))
	{
		...
		if($sql2){
			...
			echo"<script type='text/javascript'>window.location = 'about_title';</script>";
		}
...
?>
	<!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
  			<div class="header">
            <h2>Edit <strong>About Page</strong></h2>
            ...
            <div class="col-lg-12 portlets">
				<div class="panel panel-default no-bd">
					<div class="panel-header bg-dark">
					  <h2 class="panel-title"><strong>Edit </strong> About Page</h2>
					</div>
