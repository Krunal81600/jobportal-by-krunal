...
if($_REQUEST['approved'])
{
    ...
    mysqli_query($con,"UPDATE `post_job` SET `ad_app`='1' WHERE id='$id'");
    ...
    echo "window.location='unapppost'";
    echo "</script>";
 ...
 ?> 
        ...
        <div class="page-content">
          <div class="header">
            <h2>Company Unapproved Post <strong>Job</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="index">Dashboard</a>
                </li>
				<li><a href="view?id=<?php echo $id; ?>">View</a></li>
                <li class="active">Company Unapproved Post Job</li>
              </ol>
            </div>
          </div>
		  <?php
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-table"></i> <strong>Company Unapproved Post Job </strong> List</h3>
                </div>
                <div class="panel-content pagination2 table-responsive">
                  <table class="table table-hover table-dynamic">
					...
					$res=mysqli_query($con,"SELECT * FROM `post_job` WHERE ad_app='0' ORDER BY  `id` DESC");
					...
					?>
						<tr>
							...
							<a class="btn btn-danger" href="delete?id=<?php echo $rowre['id']; ?>&post=post"> Delete </a>
							<a class="btn btn-success" href="unapppost?id=<?php echo $rowre['id']; ?>&approved=approved"> Approve </a></td>
						</tr>
					<?php } ?>
                    </tbody>
                  </table>
