<?php
	include('../config.php');
	include('header.php');
	$sql1 = mysqli_query($con,"SELECT * FROM `terms_condition` WHERE id='1'");
	...
	if(isset($_POST['submit']))
	{
		...
		$sql2 = mysqli_query($con,"UPDATE `all_title` SET title1='$title1' WHERE page_nm='terms_condition'");
		
		$sql2 = mysqli_query($con,"UPDATE `terms_condition` SET content='$content' WHERE id='1'");
		if($sql2){ echo"<script type='text/javascript'>alert('Edit Successfully');</script>"; }
		echo"<script type='text/javascript'>window.location = 'terms_condition';</script>";
	}
?>
	<!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
  			<div class="header">
            <h2>Edit <strong>Terms & Condition Page</strong></h2>
            ...
            <div class="col-lg-12 portlets">
				<div class="panel panel-default no-bd">
					<div class="panel-header bg-dark">
					  <h2 class="panel-title"><strong>Edit </strong> Terms & Condition</h2>
					</div>
