...
.btn 
{
	padding:8px 5px 8px 10px !important;}
        ...
        <div class="page-content">
          <div class="header">
            <h2>All Company <strong>List</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-table"></i> <strong>All Company </strong> List</h3>
                </div>
                <div class="panel-content pagination2 table-responsive">
                  <table class="table table-hover table-dynamic">
                    <thead>
						...
						<?php
						$no=0;
						$a=mysqli_query($con,"SELECT * FROM `user` WHERE rtype='Employer' AND ac_dac=' ' AND cactive='1' ORDER BY  `id` DESC");
